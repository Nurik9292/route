...
import { pluralize, provideReadonly, eventBus } from '@/utils';
...
export default {
    ...
    async created() {
        ...
        provideReadonly(SelectedStopsKey, this.selectedStops);
        provideReadonly(StopListConfigKey, this.config);
        provideReadonly(StopListContextKey, { type: 'Stops' });
        provideReadonly(StopListSortFieldKey, this.sortField);
        provideReadonly(StopListSortOrderKey, this.sortOrder);
        provideReadonly(StopListFilterKeywordsKey, this.filterKeywords);
    },
    ...
    methods: {
        ...
        pluralizes() {
            pluralize(this.totalStopCount, 'stops');
        },
